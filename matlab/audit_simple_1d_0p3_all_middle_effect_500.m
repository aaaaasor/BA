function audit=audit_simple_1d_0p3_all_middle_effect_500()
...
[m,idx]=fit_selected(D.X,D.Y,.3,H.SigmaN,H.SigmaF,H.SigmaL(:,1));assert(numel(idx)==471);
...
save(fullfile(out,'Simple1D_0p3_vs_All_Middle_Sample_Effect_500.mat'),'audit','-v7.3');
end
