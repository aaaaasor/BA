% Recreate the original complete 2D training trajectories from the generator.
function points = generate_original_training_points_2d(n_points, n_trajectories)
...
points = nan(n_points, n_trajectories, 2);
