...
control_trace_u_only = collect_control_trace && struct_field_default( ...
...
elseif collect_control_trace
	trace_capacity = 4 * n_steps;
	sample_diag = init_control_trace_diagnostics( ...
		trace_capacity, state_dim, control_trace_u_only);
else
