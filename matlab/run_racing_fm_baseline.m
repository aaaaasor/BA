function run_racing_fm_baseline()
...
% Force only the three FM rollout caches and metric file to rebuild.
...
fprintf('\n===== Racing FM baseline: PTCLF + endpoint snap only =====\n');
...
fprintf('RACING FM BASELINE COMPLETE AND SEEDS VERIFIED.\n');
end
